    ...
    >
      <Link href={href} className="group block h-full">
        <div className="h-full p-6 rounded-2xl bg-white dark:bg-[#162B1E] border border-[#E2D9CC] dark:border-[#2A4035] shadow-sm transition-all duration-200 hover:-translate-y-2 hover:shadow-xl hover:border-[#C8A87A]/50 dark:hover:border-[#C8A87A]/40">
          <div className="w-12 h-12 rounded-xl bg-[#1C3A2A]/8 dark:bg-[#C8A87A]/10 flex items-center justify-center mb-5 text-[#1C3A2A] dark:text-[#C8A87A] transition-all duration-200 group-hover:bg-[#1C3A2A] group-hover:text-white dark:group-hover:bg-[#C8A87A] dark:group-hover:text-[#1C3A2A]">
            {icon}
          </div>
